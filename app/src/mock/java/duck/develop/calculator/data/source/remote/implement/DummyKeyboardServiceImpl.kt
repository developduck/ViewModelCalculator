...
class DummyKeyboardServiceImpl: KeyboardService {
    override suspend fun getKeyboardVersion(id: Int): Root<Keyboard> {
        val dummyJson = "{\"code\":200,\"message\":\"Success\",\"data\":{\"version\":1566457264000,\"id\":1}}"
        return Gson().fromJson(dummyJson, object: TypeToken<Root<Keyboard>>() {}.type) as Root<Keyboard>
    }
