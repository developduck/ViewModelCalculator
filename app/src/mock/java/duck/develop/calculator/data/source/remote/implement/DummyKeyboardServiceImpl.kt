...
class DummyKeyboardServiceImpl: KeyboardService {
    override fun getKeyboardJoinKeyAll(id: Int): LiveData<Root<SelectKeyboardJoinKeyAll>> {
        ...
        return object: LiveData<Root<SelectKeyboardJoinKeyAll>>() {
            override fun onActive() {
                super.onActive()
                postValue(Gson().fromJson(dummyJson, object: TypeToken<Root<SelectKeyboardJoinKeyAll>>() {}.type) as Root<SelectKeyboardJoinKeyAll>)
            }
        }
    }
}